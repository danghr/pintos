...
struct sup_page_table_entry *sup_page_find_entry_uaddr (struct thread *, 
  void *);
struct sup_page_table_entry *sup_page_find_entry_frame (struct thread *, 
  void *);
...
bool sup_page_write_page_mmap_to_filesys (struct sup_page_table_entry *, 
  void *);
struct sup_page_table_entry *sup_page_allocate_mmap_page (struct thread *, 
  void *, struct file *, off_t, uint32_t, uint32_t, bool);
struct sup_page_table_entry *sup_page_install_mmap_page (struct thread *, 
  void *, struct file *, off_t, uint32_t, uint32_t, bool);
